...
import static TransR.Gradient.calc_sum;
...
public class Test {
    ...
    private void Read_Wr_File(String file_name, double[][][] wr_vec) throws IOException {
        File f = new File(file_name);
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(f),"UTF-8"));
        String line;
    ...
    public void run() throws IOException {
        ...
        Read_Wr_File("resource/result/Wr_vec.bern", Wr_vec);
